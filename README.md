...
This fork contains additionnal implementation of Stereo Unscented Kalman Filter on Lie group and Stereo Invariant Extended Kalman Filter.

The software is tested on Ubuntu 16.04 with ROS Kinetic.

Original Video: [https://www.youtube.com/watch?v=jxfJFgzmNSw&t=3s](https://www.youtube.com/watch?v=jxfJFgzmNSw&t=3s)
Original Paper Draft: [https://arxiv.org/abs/1712.00036](https://arxiv.org/abs/1712.00036)
...
Edit the file `msckf_vio_*.launch` for selection S-MSCKF, S-UKF-LG, or S-IEKF vio filter. 
